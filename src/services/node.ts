...
export type AddNodeParams = Pick<NewNode, "name" | "host" | "port" | "protocol"> &
  Partial<Pick<NewNode, "stats_port" | "stats_secret" | "sni" | "cert_path" | "cert_expires" | "hy2_version" | "config_path" | "ssh_user" | "ssh_port" | "ssh_alias" | "cert_fingerprint" | "insecure" | "obfs_password" | "port_hopping" | "enabled">>;
